...
@implementation SMTCollectViewCicleLayout
{
...
-(void)prepareLayout{
    ...
    for (int i=0; i<itemCount; i++) {
        ...
        float x = center.x+cosf(2*M_PI/itemCount*i)*(radius-25);
        float y = center.y+sinf(2*M_PI/itemCount*i)*(radius-25);
